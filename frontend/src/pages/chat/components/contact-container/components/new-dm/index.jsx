...
import { animationDefaultOptiuons, getColor } from "@/lib/utils";
                                        ...
                                        >
                                            <div className="w-12 h-12 relative">
                                                <Avatar className="h-12 w-12 rounded-full overflow-hidden">
                                                    {
                                                        contact.image ? (
                                                            <AvatarImage src={`${HOST}/${contact.image}` || "https://github.com/shadcn.png"} className="object-cover w-full h-full bg-black rounded-full" />
                                                        ) : (
                        ...
                        )}
                    {
                        searchedContacts.length <= 0 && (
                            <div className="flex-1 md:flex mt-5 md:mt-0 flex-col justify-center items-center duration-1000 transition-all">
                                <Lottie
                                    animationData={animationDefaultOptiuons.animationData}
                                    loop={animationDefaultOptiuons.loop}
                                    autoplay={animationDefaultOptiuons.autoplay}
